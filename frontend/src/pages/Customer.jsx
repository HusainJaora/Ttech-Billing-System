...
export const CustomerList = () => { 
  ...
  }, [loading, customers.length, restoreScroll]);
...
// Edit Customer Component with state persistenc
export const EditCustomer = () => {
  ...
  useEffect(() => {
    ...
    if (isDifferent) {
      // Save to session storage if different from original
