...
// Quotation Terms & Conditions Page Component
export const QuotationTermsConditions = () => {
  ...
  const fetchTerms = async () => {
    try {
      ...
      const response = await axiosInstance.get(ENDPOINTS.QUOTATION_TERMS_CONDITIONS.GET_TERM);
  ...
  const handleAddTerms = async () => {
    ...
    try {
      const response = await axiosInstance.post(
        ENDPOINTS.QUOTATION_TERMS_CONDITIONS.ADD_TERM,
        { terms: validTerms }
      );
  ...
  const handleUpdateTerm = async (termId) => {
    ...
    try {
      const response = await axiosInstance.put(
        `${ENDPOINTS.QUOTATION_TERMS_CONDITIONS.UPDATE_TERM}/${termId}`,
  ...
  const confirmDelete = async () => {
    ...
    try {
      const response = await axiosInstance.delete(
        `${ENDPOINTS.QUOTATION_TERMS_CONDITIONS.DELETE_TERM}/${termToDelete.terms_id}`
      );
            ...
            <div className="flex items-center space-x-4 ml-12 lg:ml-0">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 flex items-center mt-1">
                  ...
                  Manage your quotation terms (Max: 4 terms)
                </p>
              </div>
            </div>
            {terms.length < 4 && (
